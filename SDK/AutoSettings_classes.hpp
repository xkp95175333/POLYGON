...
public:
	...
	uint8                                         Pad_58[0x6];                                       // 0x0292(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_59[0x5];                                       // 0x02CB(0x0005)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAutoSettingWidget) == 0x0002D0, "Wrong size on UAutoSettingWidget");
static_assert(offsetof(UAutoSettingWidget, CVarName) == 0x000280, "Member 'UAutoSettingWidget::CVarName' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, ValueMask) == 0x000288, "Member 'UAutoSettingWidget::ValueMask' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bAutoSave) == 0x000290, "Member 'UAutoSettingWidget::bAutoSave' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bAutoApply) == 0x000291, "Member 'UAutoSettingWidget::bAutoApply' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, SettingTags) == 0x000298, "Member 'UAutoSettingWidget::SettingTags' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, CurrentValue) == 0x0002B8, "Member 'UAutoSettingWidget::CurrentValue' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bHasUnappliedChange) == 0x0002C8, "Member 'UAutoSettingWidget::bHasUnappliedChange' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bHasUnsavedChange) == 0x0002C9, "Member 'UAutoSettingWidget::bHasUnsavedChange' has a wrong offset!");
static_assert(offsetof(UAutoSettingWidget, bUpdatingSettingSelection) == 0x0002CA, "Member 'UAutoSettingWidget::bUpdatingSettingSelection' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_5B[0x7];                                       // 0x02E9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USelectSetting) == 0x0002F0, "Wrong size on USelectSetting");
static_assert(offsetof(USelectSetting, Options) == 0x0002D0, "Member 'USelectSetting::Options' has a wrong offset!");
static_assert(offsetof(USelectSetting, OptionFactory) == 0x0002E0, "Member 'USelectSetting::OptionFactory' has a wrong offset!");
static_assert(offsetof(USelectSetting, bUpdatingSettingOptions) == 0x0002E8, "Member 'USelectSetting::bUpdatingSettingOptions' has a wrong offset!");
...
{
public:
	uint8                                         Pad_5C[0x58];                                      // 0x0028(0x0058)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UToggleSetting) == 0x0002D0, "Wrong size on UToggleSetting");
...
static_assert(sizeof(UCheckBoxSetting) == 0x0002D8, "Wrong size on UCheckBoxSetting");
static_assert(offsetof(UCheckBoxSetting, CheckBox) == 0x0002D0, "Member 'UCheckBoxSetting::CheckBox' has a wrong offset!");
...
static_assert(sizeof(UComboBoxSetting) == 0x0002F8, "Wrong size on UComboBoxSetting");
static_assert(offsetof(UComboBoxSetting, ComboBox) == 0x0002F0, "Member 'UComboBoxSetting::ComboBox' has a wrong offset!");
...
static_assert(sizeof(USliderSetting) == 0x0002D8, "Wrong size on USliderSetting");
static_assert(offsetof(USliderSetting, LeftValue) == 0x0002D0, "Member 'USliderSetting::LeftValue' has a wrong offset!");
static_assert(offsetof(USliderSetting, RightValue) == 0x0002D4, "Member 'USliderSetting::RightValue' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_65[0x7];                                       // 0x02E1(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UNativeSliderSetting) == 0x0002E8, "Wrong size on UNativeSliderSetting");
static_assert(offsetof(UNativeSliderSetting, Slider) == 0x0002D8, "Member 'UNativeSliderSetting::Slider' has a wrong offset!");
static_assert(offsetof(UNativeSliderSetting, bMouseCaptureInProgress) == 0x0002E0, "Member 'UNativeSliderSetting::bMouseCaptureInProgress' has a wrong offset!");
...
{
public:
	FMulticastInlineDelegateProperty_             OnSelected;                                        // 0x0280(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_66[0x7];                                       // 0x02B9(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(URadioButton) == 0x0002C0, "Wrong size on URadioButton");
static_assert(offsetof(URadioButton, OnSelected) == 0x000280, "Member 'URadioButton::OnSelected' has a wrong offset!");
static_assert(offsetof(URadioButton, Label) == 0x000290, "Member 'URadioButton::Label' has a wrong offset!");
static_assert(offsetof(URadioButton, Value) == 0x0002A8, "Member 'URadioButton::Value' has a wrong offset!");
static_assert(offsetof(URadioButton, Selected) == 0x0002B8, "Member 'URadioButton::Selected' has a wrong offset!");
...
public:
	...
	FMulticastInlineDelegateProperty_             SelectionChangedEvent;                             // 0x0298(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(URadioSelect) == 0x0002C0, "Wrong size on URadioSelect");
static_assert(offsetof(URadioSelect, Options) == 0x000280, "Member 'URadioSelect::Options' has a wrong offset!");
static_assert(offsetof(URadioSelect, RadioButtonClass) == 0x000290, "Member 'URadioSelect::RadioButtonClass' has a wrong offset!");
static_assert(offsetof(URadioSelect, SelectionChangedEvent) == 0x000298, "Member 'URadioSelect::SelectionChangedEvent' has a wrong offset!");
static_assert(offsetof(URadioSelect, ButtonContainer) == 0x0002A8, "Member 'URadioSelect::ButtonContainer' has a wrong offset!");
static_assert(offsetof(URadioSelect, RadioButtons) == 0x0002B0, "Member 'URadioSelect::RadioButtons' has a wrong offset!");
...
static_assert(sizeof(URadioSelectSetting) == 0x000300, "Wrong size on URadioSelectSetting");
static_assert(offsetof(URadioSelectSetting, RadioButtonClass) == 0x0002F0, "Member 'URadioSelectSetting::RadioButtonClass' has a wrong offset!");
static_assert(offsetof(URadioSelectSetting, RadioSelect) == 0x0002F8, "Member 'URadioSelectSetting::RadioSelect' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_74[0x7];                                       // 0x0291(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             SelectionChangedEvent;                             // 0x0298(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_75[0x8];                                       // 0x02A8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(USpinner) == 0x0002B0, "Wrong size on USpinner");
static_assert(offsetof(USpinner, Options) == 0x000280, "Member 'USpinner::Options' has a wrong offset!");
static_assert(offsetof(USpinner, bAllowWrapping) == 0x000290, "Member 'USpinner::bAllowWrapping' has a wrong offset!");
static_assert(offsetof(USpinner, SelectionChangedEvent) == 0x000298, "Member 'USpinner::SelectionChangedEvent' has a wrong offset!");
...
static_assert(sizeof(USpinnerSetting) == 0x0002F8, "Wrong size on USpinnerSetting");
static_assert(offsetof(USpinnerSetting, Spinner) == 0x0002F0, "Member 'USpinnerSetting::Spinner' has a wrong offset!");
