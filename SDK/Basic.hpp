...
namespace Offsets
{
	constexpr int32 GObjects          = 0x07F99230;
	constexpr int32 AppendString      = 0x029FA8E0;
	constexpr int32 GNames            = 0x07EF2B80;
	constexpr int32 GWorld            = 0x080F22D0;
	constexpr int32 ProcessEvent      = 0x02BA05A0;
