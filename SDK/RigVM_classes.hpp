...
public:
	...
	uint8                                         Pad_2963[0x10];                                    // 0x0088(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_2964[0x8];                                     // 0x0028(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMRuntimeSettings                  VMRuntimeSettings;                                 // 0x0030(0x0018)(NativeAccessSpecifierPublic)
	uint8                                         Pad_2965[0x10];                                    // 0x0048(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2966[0x18];                                    // 0x0078(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           EventQueue;                                        // 0x0090(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	uint8                                         Pad_2967[0x90];                                    // 0x00A0(0x0090)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2968[0x40];                                    // 0x0140(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_296F[0x8];                                     // 0x0370(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMGraphFunctionStore               GraphFunctionStore;                                // 0x0378(0x0020)(NativeAccessSpecifierPublic)
	uint8                                         Pad_2970[0x8];                                     // 0x0398(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_2971[0x20];                                    // 0x0040(0x0020)(Fixing Size After Last Property [ Dumper-7 ])
	struct FRigVMByteCode                         ByteCodeStorage;                                   // 0x0060(0x0090)(HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_2972[0x8];                                     // 0x00F0(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2973[0x4];                                     // 0x0214(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class FName>                           FunctionNamesStorage;                              // 0x0218(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_2974[0x38];                                    // 0x0228(0x0038)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2975[0xE8];                                    // 0x02C0(0x00E8)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_2976[0x40];                                    // 0x03B0(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_298A[0x40];                                    // 0x0220(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_298B[0x28];                                    // 0x03F0(0x0028)(Fixing Struct Size After Last Property [ Dumper-7 ])
