...
public:
	...
	uint8                                         Pad_1BF2[0x7];                                     // 0x0039(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	TSoftObjectPtr<class UMeshDeformer>           DefaultDeformer;                                   // 0x0040(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TSoftObjectPtr<class UMeshDeformer>           DefaultRecomputeTangentDeformer;                   // 0x0070(0x0030)(Edit, Config, UObjectWrapper, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UOptimusSettings) == 0x0000A0, "Wrong size on UOptimusSettings");
...
static_assert(offsetof(UOptimusSettings, DefaultRecomputeTangentDeformer) == 0x000070, "Member 'UOptimusSettings::DefaultRecomputeTangentDeformer' has a wrong offset!");
