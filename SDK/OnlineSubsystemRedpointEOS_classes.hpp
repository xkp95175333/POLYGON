...
{
public:
	uint8                                         Pad_20C8[0x220];                                   // 0x0080(0x0220)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEOSIpNetConnection) == 0x001E48, "Wrong size on UEOSIpNetConnection");
...
{
public:
	uint8                                         Pad_20C9[0x10];                                    // 0x1DB8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UEOSNetConnection) == 0x001DC8, "Wrong size on UEOSNetConnection");
...
{
public:
	uint8                                         Pad_20CA[0x68];                                    // 0x0858(0x0068)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UEOSNetConnection*>              PendingConnectionClose;                            // 0x08C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UEOSNetDriver) == 0x0008D0, "Wrong size on UEOSNetDriver");
static_assert(offsetof(UEOSNetDriver, PendingConnectionClose) == 0x0008C0, "Member 'UEOSNetDriver::PendingConnectionClose' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_20CB[0x18];                                    // 0x0050(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_20CC[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_20CD[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_20CE[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_20CF[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_20D0[0x10];                                    // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_20D1[0x60];                                    // 0x0030(0x0060)(Fixing Struct Size After Last Property [ Dumper-7 ])
