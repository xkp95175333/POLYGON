...
public:
	...
	uint8                                         Pad_1011[0x3];                                     // 0x028D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInputLabel) == 0x0002B0, "Wrong size on UInputLabel");
static_assert(offsetof(UInputLabel, MappingGroup) == 0x000280, "Member 'UInputLabel::MappingGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, KeyGroup) == 0x000284, "Member 'UInputLabel::KeyGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, bUsePlayerKeyGroup) == 0x00028C, "Member 'UInputLabel::bUsePlayerKeyGroup' has a wrong offset!");
static_assert(offsetof(UInputLabel, IconTags) == 0x000290, "Member 'UInputLabel::IconTags' has a wrong offset!");
...
static_assert(sizeof(UActionLabel) == 0x000318, "Wrong size on UActionLabel");
static_assert(offsetof(UActionLabel, ActionName) == 0x0002B0, "Member 'UActionLabel::ActionName' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeyLabelWidgetClass) == 0x0002B8, "Member 'UActionLabel::KeyLabelWidgetClass' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeySeparatorWidgetClass) == 0x0002C0, "Member 'UActionLabel::KeySeparatorWidgetClass' has a wrong offset!");
static_assert(offsetof(UActionLabel, KeyContainer) == 0x0002C8, "Member 'UActionLabel::KeyContainer' has a wrong offset!");
static_assert(offsetof(UActionLabel, PrimaryKeyLabel) == 0x0002D0, "Member 'UActionLabel::PrimaryKeyLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, ShiftLabel) == 0x0002D8, "Member 'UActionLabel::ShiftLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, CtrlLabel) == 0x0002E0, "Member 'UActionLabel::CtrlLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, AltLabel) == 0x0002E8, "Member 'UActionLabel::AltLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, CmdLabel) == 0x0002F0, "Member 'UActionLabel::CmdLabel' has a wrong offset!");
static_assert(offsetof(UActionLabel, ShiftSeparator) == 0x0002F8, "Member 'UActionLabel::ShiftSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, CtrlSeparator) == 0x000300, "Member 'UActionLabel::CtrlSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, AltSeparator) == 0x000308, "Member 'UActionLabel::AltSeparator' has a wrong offset!");
static_assert(offsetof(UActionLabel, CmdSeparator) == 0x000310, "Member 'UActionLabel::CmdSeparator' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1012[0x8];                                     // 0x0030(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1013[0x4];                                     // 0x028C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UInputMapping) == 0x0002B8, "Wrong size on UInputMapping");
static_assert(offsetof(UInputMapping, MappingGroup) == 0x000280, "Member 'UInputMapping::MappingGroup' has a wrong offset!");
static_assert(offsetof(UInputMapping, KeyGroup) == 0x000284, "Member 'UInputMapping::KeyGroup' has a wrong offset!");
static_assert(offsetof(UInputMapping, IconTags) == 0x000290, "Member 'UInputMapping::IconTags' has a wrong offset!");
static_assert(offsetof(UInputMapping, BindCaptureButton) == 0x0002B0, "Member 'UInputMapping::BindCaptureButton' has a wrong offset!");
...
static_assert(sizeof(UActionMapping) == 0x0002C8, "Wrong size on UActionMapping");
static_assert(offsetof(UActionMapping, ActionName) == 0x0002B8, "Member 'UActionMapping::ActionName' has a wrong offset!");
static_assert(offsetof(UActionMapping, ActionLabel) == 0x0002C0, "Member 'UActionMapping::ActionLabel' has a wrong offset!");
...
{
public:
	uint8                                         Pad_1014[0x8];                                     // 0x0038(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1015[0x6];                                     // 0x0042(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1016[0x7];                                     // 0x00B9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1017[0x4];                                     // 0x0154(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1019[0x4];                                     // 0x02BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAxisLabel) == 0x0002C8, "Wrong size on UAxisLabel");
static_assert(offsetof(UAxisLabel, AxisName) == 0x0002B0, "Member 'UAxisLabel::AxisName' has a wrong offset!");
static_assert(offsetof(UAxisLabel, Scale) == 0x0002B8, "Member 'UAxisLabel::Scale' has a wrong offset!");
static_assert(offsetof(UAxisLabel, KeyLabel) == 0x0002C0, "Member 'UAxisLabel::KeyLabel' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_101A[0x4];                                     // 0x02C4(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAxisMapping) == 0x0002D0, "Wrong size on UAxisMapping");
static_assert(offsetof(UAxisMapping, AxisName) == 0x0002B8, "Member 'UAxisMapping::AxisName' has a wrong offset!");
static_assert(offsetof(UAxisMapping, Scale) == 0x0002C0, "Member 'UAxisMapping::Scale' has a wrong offset!");
static_assert(offsetof(UAxisMapping, AxisLabel) == 0x0002C8, "Member 'UAxisMapping::AxisLabel' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_101B[0x14];                                    // 0x0294(0x0014)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UBindCaptureButton) == 0x0002B0, "Wrong size on UBindCaptureButton");
static_assert(offsetof(UBindCaptureButton, KeyGroup) == 0x000280, "Member 'UBindCaptureButton::KeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, BindCapturePromptClass) == 0x000288, "Member 'UBindCaptureButton::BindCapturePromptClass' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, CapturePromptZOrder) == 0x000290, "Member 'UBindCaptureButton::CapturePromptZOrder' has a wrong offset!");
static_assert(offsetof(UBindCaptureButton, Prompt) == 0x0002A8, "Member 'UBindCaptureButton::Prompt' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_101C[0x1];                                     // 0x0283(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGameplayTag                           KeyGroup;                                          // 0x0284(0x0008)(NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_101D[0x4];                                     // 0x028C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	FMulticastInlineDelegateProperty_             OnChordCaptured;                                   // 0x0290(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnChordRejected;                                   // 0x02A0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnCapturePromptClosed;                             // 0x02B0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_101E[0x7];                                     // 0x02D1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UBindCapturePrompt) == 0x0002E8, "Wrong size on UBindCapturePrompt");
static_assert(offsetof(UBindCapturePrompt, bIgnoreGameViewportInputWhileCapturing) == 0x000280, "Member 'UBindCapturePrompt::bIgnoreGameViewportInputWhileCapturing' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, bRestrictKeyGroup) == 0x000281, "Member 'UBindCapturePrompt::bRestrictKeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, CaptureMode) == 0x000282, "Member 'UBindCapturePrompt::CaptureMode' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, KeyGroup) == 0x000284, "Member 'UBindCapturePrompt::KeyGroup' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnChordCaptured) == 0x000290, "Member 'UBindCapturePrompt::OnChordCaptured' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnChordRejected) == 0x0002A0, "Member 'UBindCapturePrompt::OnChordRejected' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, OnCapturePromptClosed) == 0x0002B0, "Member 'UBindCapturePrompt::OnCapturePromptClosed' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, KeysDown) == 0x0002C0, "Member 'UBindCapturePrompt::KeysDown' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, PreviousIgnoreInput) == 0x0002D0, "Member 'UBindCapturePrompt::PreviousIgnoreInput' has a wrong offset!");
static_assert(offsetof(UBindCapturePrompt, AccumulatedMouseDelta) == 0x0002D8, "Member 'UBindCapturePrompt::AccumulatedMouseDelta' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_102B[0x4];                                     // 0x02CC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UKeyLabel) == 0x0002F0, "Wrong size on UKeyLabel");
static_assert(offsetof(UKeyLabel, KeyInvalidText) == 0x000280, "Member 'UKeyLabel::KeyInvalidText' has a wrong offset!");
static_assert(offsetof(UKeyLabel, LabelOverride) == 0x000298, "Member 'UKeyLabel::LabelOverride' has a wrong offset!");
static_assert(offsetof(UKeyLabel, Key) == 0x0002B0, "Member 'UKeyLabel::Key' has a wrong offset!");
static_assert(offsetof(UKeyLabel, AxisScale) == 0x0002C8, "Member 'UKeyLabel::AxisScale' has a wrong offset!");
static_assert(offsetof(UKeyLabel, IconTags) == 0x0002D0, "Member 'UKeyLabel::IconTags' has a wrong offset!");
