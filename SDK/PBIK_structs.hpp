...
public:
	...
	uint8                                         Pad_323A[0x3];                                     // 0x0011(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_323B[0x3];                                     // 0x001D(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_323C[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_323D[0x3];                                     // 0x0035(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_323E[0x2];                                     // 0x000A(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_323F[0x3];                                     // 0x0039(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
{
public:
	uint8                                         Pad_3240[0x68];                                    // 0x0000(0x0068)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3241[0x3];                                     // 0x0005(0x0003)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_3242[0x8];                                     // 0x0008(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_3243[0xC];                                     // 0x0084(0x000C)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	TArray<int32>                                 EffectorSolverIndices;                             // 0x0148(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_3244[0x4];                                     // 0x01BC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<int32>                                 BoneSettingToSolverBoneIndex;                      // 0x01C0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	TArray<int32>                                 SolverBoneToElementIndex;                          // 0x01D0(0x0010)(ZeroConstructor, Transient, NativeAccessSpecifierPublic)
	...
	uint8                                         Pad_3245[0x7];                                     // 0x0249(0x0007)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
static_assert(alignof(FRigUnit_PBIK) == 0x000010, "Wrong alignment on FRigUnit_PBIK");
static_assert(sizeof(FRigUnit_PBIK) == 0x000250, "Wrong size on FRigUnit_PBIK");
static_assert(offsetof(FRigUnit_PBIK, Root) == 0x000130, "Member 'FRigUnit_PBIK::Root' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Effectors) == 0x000138, "Member 'FRigUnit_PBIK::Effectors' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, EffectorSolverIndices) == 0x000148, "Member 'FRigUnit_PBIK::EffectorSolverIndices' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, BoneSettings) == 0x000158, "Member 'FRigUnit_PBIK::BoneSettings' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, ExcludedBones) == 0x000168, "Member 'FRigUnit_PBIK::ExcludedBones' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Settings) == 0x000178, "Member 'FRigUnit_PBIK::Settings' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Debug) == 0x0001B4, "Member 'FRigUnit_PBIK::Debug' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, BoneSettingToSolverBoneIndex) == 0x0001C0, "Member 'FRigUnit_PBIK::BoneSettingToSolverBoneIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, SolverBoneToElementIndex) == 0x0001D0, "Member 'FRigUnit_PBIK::SolverBoneToElementIndex' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, Solver) == 0x0001E0, "Member 'FRigUnit_PBIK::Solver' has a wrong offset!");
static_assert(offsetof(FRigUnit_PBIK, bNeedsInit) == 0x000248, "Member 'FRigUnit_PBIK::bNeedsInit' has a wrong offset!");
