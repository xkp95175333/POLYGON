...
{
public:
	uint8                                         Pad_2B79[0x10];                                    // 0x05A0(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCustomMeshComponent) == 0x0005B0, "Wrong size on UCustomMeshComponent");
